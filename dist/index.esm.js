...
var FancyButton = function (props) {
    ...
    var _o = useState(false), isActive = _o[0], setIsActive = _o[1];
    ...
    return (jsxs("button", __assign({ ref: buttonRef, className: classes, style: finalStyle, onClick: handleClick, onMouseEnter: function () { return setIsHovered(true); }, onMouseLeave: function () {
            setIsHovered(false);
            setIsActive(false);
        }, onMouseDown: function () { return setIsActive(true); }, onMouseUp: function () { return setIsActive(false); }, disabled: disabled }, otherProps, { children: [startIcon && jsx("span", { className: "btn-icon start", children: startIcon }), !iconOnly && jsx("span", { className: "btn-label", children: children }), endIcon && jsx("span", { className: "btn-icon end", children: endIcon })] })));
};

export { FancyButton, FancyButton as default };
